<?php $__env->startSection('title', 'À propos - Para4You'); ?>
    ...
    <div class="row justify-content-center">
      ...
      <div class="offset-md-0 offset-lg-1 col-sm-12 col-md-5 col-lg-5 col-xl-4" data-aos="fade-up">
        <div class="px-3">
          ...
          <p>
            <a href="<?php echo e(route('produits.index')); ?>" class="btn-get-started">Découvrez nos produits</a>
          </p>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\para\resources\views/about.blade.php ENDPATH**/ ?>