<?php $__env->startSection('title', 'Admin Dashboard - Para4You'); ?>
...
<div class="container">
  <div class="admin-header">
    ...
    <a href="<?php echo e(route('logout')); ?>" class="admin-logout">
  ...
  <div class="admin-stats">
    <div class="admin-card">
      ...
      <div class="card-value"><?php echo e(count($products)); ?></div>
    </div>
    
    <div class="admin-card">
      <div class="card-title">TOTAL ORDERS</div>
      <div class="card-value"><?php echo e(count($orders)); ?></div>
    </div>
    
    <div class="admin-card">
      <div class="card-title">TOTAL REVENUE</div>
      <div class="card-value">$<?php echo e(number_format($orders->sum('total_amount') ?? 0, 2)); ?></div>
    </div>
    
    <div class="admin-card">
      <div class="card-title">PENDING ORDERS</div>
      <div class="card-value"><?php echo e($orders->where('status', 'pending')->count()); ?></div>
    </div>
  </div>
      ...
      <tbody>
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td>
              <button class="btn btn-sm" data-id="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>" data-price="<?php echo e($product->price); ?>" data-toggle="modal" data-target="#editProductModal">
      ...
      <tbody>
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td><?php echo e($order->customer_name ?? ($order->user->name ?? 'N/A')); ?></td>
            ...
            <td>
              <a href="#" class="btn btn-sm view-order" data-id="<?php echo e($order->id); ?>" title="View Details">
                <i class="material-icons">visibility</i>
              </a>
              <a href="#" class="btn btn-sm edit-status" data-id="<?php echo e($order->id); ?>" title="Edit Status">
                <i class="material-icons">edit</i>
              </a>
            </td>
          </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addProductForm" method="POST" action="<?php echo e(route('products.store')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          
          <!-- Product Name -->
          <div class="mb-3">
              <label for="productName" class="form-label">Product Name</label>
              <input type="text" class="form-control" id="product_name" name="name" value="<?php echo e(old('name')); ?>" required>
          </div>

          <!-- Product Description -->
          <div class="mb-3">
              <label for="productDescription" class="form-label">Product Description</label>
              <textarea class="form-control" id="productDescription" name="description" required><?php echo e(old('description')); ?></textarea>
          </div>

          <!-- Product Price -->
          <div class="mb-3">
              <label for="productPrice" class="form-label">Product Price</label>
              <input type="number" class="form-control" id="product_price" name="price" value="<?php echo e(old('price')); ?>" required>
          </div>
          ...
          <div class="mb-3">
              ...
              <select class="form-control" id="category" name="category" required>
                  <option value="Face" <?php echo e(old('category') == 'Face' ? 'selected' : ''); ?>>Face</option>
                  <option value="Lip" <?php echo e(old('category') == 'Lip' ? 'selected' : ''); ?>>Lip</option>
                  <option value="Body" <?php echo e(old('category') == 'Body' ? 'selected' : ''); ?>>Body</option>
                  <option value="Hair" <?php echo e(old('category') == 'Hair' ? 'selected' : ''); ?>>Hair</option>
              </select>
          </div>
...
<div class="modal fade" id="addOrderModal" tabindex="-1" aria-labelledby="addOrderModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addOrderForm" method="POST" action="<?php echo e(route('orders.store')); ?>">
          <?php echo csrf_field(); ?>
          ...
          <div class="mb-3">
              ...
              <select class="form-control" id="product_id" name="product_id" required>
                  <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?> - $<?php echo e(number_format($product->price, 2)); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\para\resources\views/admin.blade.php ENDPATH**/ ?>