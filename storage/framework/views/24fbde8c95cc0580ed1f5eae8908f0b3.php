<?php $__env->startSection('title', 'Mon Profil - Para4You'); ?>
...
<div class="container py-5" data-user-logged-in="<?php echo e(session('user_id') ? 'true' : 'false'); ?>">
            ...
            <div id="edit-profile-form" class="bg-white rounded-lg shadow-md p-4 mt-4 hidden">
                ...
                <form action="/update-profile" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control" value="<?php echo e(session('name')); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" id="email" name="email" class="form-control" value="<?php echo e(session('email')); ?>" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <div id="orders-container">
                    ...
                    <div id="no-orders" class="py-4 text-center hidden">
                        ...
                        <a href="<?php echo e(route('produits.index')); ?>" class="mt-2 d-inline-block text-primary">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\para\resources\views/profile.blade.php ENDPATH**/ ?>